package com.lilianinfo.cloud.code;
 ...
 *
 */
public enum UserTestResponseCode  {
	//操作成功
    ...
    // 构造方法  
    private UserTestResponseCode(String code,String message) {  
        this.code = code;  
	...
	public static ResponseVO buildEnumResponseVO(UserTestResponseCode userResponseCode, Object data) {
		return new ResponseVO(userResponseCode.getCode(),userResponseCode.getMessage(),data);
	}
	
	public static Map<String, Object> buildReturnMap(UserTestResponseCode fansResponseCode, Object data) {
